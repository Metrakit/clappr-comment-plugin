...
},{"lodash._basecopy":4,"lodash._basetostring":5,"lodash._basevalues":6,"lodash._isiterateecall":7,"lodash._reinterpolate":8,"lodash.escape":9,"lodash.isnative":10,"lodash.keys":12,"lodash.restparam":16,"lodash.templatesettings":17}],4:[function(require,module,exports){
/**
...
},{"lodash._basetostring":5}],10:[function(require,module,exports){
/**
...
},{"lodash.isfunction":11}],11:[function(require,module,exports){
/**
...
},{"lodash._reinterpolate":8,"lodash.escape":9}],18:[function(require,module,exports){
...
var Comments = (function (_UICorePlugin) {
  function Comments(core) {
    _classCallCheck(this, Comments);

    _get(Object.getPrototypeOf(Comments.prototype), "constructor", this).call(this, core);
    this.core = core;
    this.actualTime = 0;
  }

  _inherits(Comments, _UICorePlugin);
  ...
  _createClass(Comments, {
    ...
    make: {
      ...
      value: function make() {
        ...
        this.$el.html(JST.add).append(styleAddBtn[0]);
        ...
        $(this.$el.formComment).html(JST.form(formText)).addClass("form-comment").append(styleForm[0]).append(styleOptions);
        ...
        this.core.mediaControl.container.$el.find(".submit-comment").click(function () {
          return _this.submitComment(_this);
        });
    ...
    getComments: {
      ...
      value: function getComments(videoId) {
    ...
    displayingComment: {
      ...
      value: function displayingComment(elem) {
        var _this = this;
        ...
        this.core.mediaControl.$seekBarContainer.find(".comment-pointer").on("mouseout", function () {
          return _this.hideComment(_this);
        });
      }
    },
    createCommentPointer: {
      ...
      value: function createCommentPointer(data) {
    ...
    showComment: {
      ...
      value: function showComment(elem, pointer) {
    ...
    hideComment: {
      ...
      value: function hideComment(elem) {
    ...
    submitComment: {
      ...
      value: function submitComment(elem) {
    ...
    clickOnContainer: {
      ...
      value: function clickOnContainer() {
    ...
    timeUpdate: {
      ...
      value: function timeUpdate(position, duration) {
...
},{"./jst":18,"./styler":20}],20:[function(require,module,exports){
"use strict";
